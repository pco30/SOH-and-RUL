# -*- coding: utf-8 -*-
"""
Created on Thu May  2 04:37:57 2024

@author: HYACINTH OSEJI
"""
...
CS2_35_mod = CS2_35[CS2_35['Current(A)'] < -0.5]
CS2_35 = selection(CS2_35)
CS2_35 = CS2_35[CS2_35['Calculated_SOH(%)'] >= 70]
CS2_35 = CS2_35[CS2_35['Test_Time_charged(h)'] >= 2]
...
folder_path_3 = "C:/Users/HYACINTH OSEJI/OneDrive - University of Bath/Documents/PYTHON STUFF/CS2_33"
sheet_name_3 = ["Channel_1-006"]
CS2_33 = process_files(folder_path_3, sheet_name_3)
CS2_33 = calculate_soh(CS2_33, 0.5)
CS2_33_mod = CS2_33[CS2_33['Current(A)'] < -0.3]
CS2_33 = selection(CS2_33)
CS2_33 = CS2_33[CS2_33['Calculated_SOH(%)'] >= 70]
CS2_33 = CS2_33[CS2_33['Test_Time_charged(h)'] >= 2]

folder_path_4 = "C:/Users/HYACINTH OSEJI/OneDrive - University of Bath/Documents/PYTHON STUFF/CS2_34"
sheet_name_4 = ["Channel_1-007"]
CS2_34 = process_files(folder_path_4, sheet_name_4)
CS2_34 = calculate_soh(CS2_34, 0.5)
CS2_34_mod = CS2_34[CS2_34['Current(A)'] < -0.3]
CS2_34 = selection(CS2_34)
CS2_34 = CS2_34[CS2_34['Calculated_SOH(%)'] >= 70]
CS2_34 = CS2_34[CS2_34['Test_Time_charged(h)'] >= 2]

folder_path_5 = "C:/Users/HYACINTH OSEJI/OneDrive - University of Bath/Documents/PYTHON STUFF/CS2_37"
sheet_name_5 = ["Channel_1-010"]
CS2_37 = process_files(folder_path_5, sheet_name_5)
CS2_37 = calculate_soh(CS2_37, 1)
CS2_37_mod = CS2_37[CS2_37['Current(A)'] < -0.5]
CS2_37 = selection(CS2_37)
CS2_37 = CS2_37[CS2_37['Calculated_SOH(%)'] >= 70]
CS2_37 = CS2_37[CS2_37['Calculated_SOH(%)'] >= 70]
CS2_37 = CS2_37[CS2_37['Test_Time_charged(h)'] >= 2]

folder_path_6 = "C:/Users/HYACINTH OSEJI/OneDrive - University of Bath/Documents/PYTHON STUFF/CS2_38"
sheet_name_6 = ["Channel_1-011"]
CS2_38 = process_files(folder_path_6, sheet_name_6)
CS2_38 = calculate_soh(CS2_38, 1)
CS2_38_mod = CS2_38[CS2_38['Current(A)'] < -0.5]
CS2_38 = selection(CS2_38)
CS2_38 = CS2_38[CS2_38['Calculated_SOH(%)'] >= 70]
CS2_38 = CS2_38[CS2_38['Test_Time_charged(h)'] >= 2]


combined_df = pd.concat([CS2_35, CS2_33, CS2_34, CS2_37, CS2_38], ignore_index=True)
...
model = create_gru_model(X_train_scaled, y_train)
